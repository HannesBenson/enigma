  ...
  context '#encode_string' do
    context 'when the file does NOT exist' do
      it 'displays an error message' do
        ...
        expected_error_regex = /The file \'\/path\/does\/not\/exist\' does not exist!/
        proc { WordEncoder.encode_string_or_file(path_that_does_not_exist) }.must_output expected_error_regex
      end
    end
